...
public final class CanvasStickerView: UIView {
    ...
    let phoneImageView: UIImageView = {
        let imageView = UIImageView(image: JESticker.loadImage("phone"))
        imageView.isUserInteractionEnabled = true
        return imageView
    }()
    
    let cameraImageView = UIImageView(image: JESticker.loadImage("camera"))
    ...
    public override func layoutSubviews() {
        ...
        phoneImageView.setMask(with: JESticker.loadImage("phone"))
    }
