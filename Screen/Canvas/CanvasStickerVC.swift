...
public class JESticker {
    public static func makeCanvas() -> CanvasStickerVC {
        return CanvasStickerVC()
    }
    public static var bundle: Bundle {
        // Replace 'YourLibraryName' with the actual name of your library target.
        return Bundle(for: JESticker.self)
    }
...
public final class CanvasStickerVC: CanvasStickerBaseVC {
    
    public let mainView = CanvasStickerView()
    public let imageViewStrings = ["birthday", "cake", "cat", "cow", "dog", "pie", "rabbit"]
    public var info = StickerTextModel()
    
    public var selectedSticker: StickerView? {
        didSet {
...
extension CanvasStickerVC {
    ...
    public func getLabelbyFont(text: String, fontSize: CGFloat) -> UILabel {
        let label = UILabel()
        label.text = text
...
extension CanvasStickerVC: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.imageView.image = JESticker.loadImage(imageViewStrings[indexPath.row])
        return cell
    }
    
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let img = UIImageView(image: JESticker.loadImage(imageViewStrings[indexPath.row]))
        clearStickerInfo()
